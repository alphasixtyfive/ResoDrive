...
- Align About with HASS Connect: a larger icon, version beneath the name, wrapping text and keyboard-accessible links.
...
Automated tests cover the real Windows worker, protected storage, filesystem cleanup and failure recovery with simulated HTTP. A disposable live Nextcloud acceptance test is still required before relying on this feature operationally; see docs/REMOTE-WIPE.md.
